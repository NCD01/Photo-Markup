# API DTO Alignment Template

Document Path: `<PRIMARY_PATH>/Templates/API_Module/DTO_ALIGNMENT.md`
Version: `<VERSION>`
Owner: `<OWNER>`
Last Updated By: `<LAST_UPDATED_BY>`
Last Updated: `<DATE_YYYY-MM-DD>`
Purpose: Keep DTO definitions synchronized across module boundaries for the API module.
